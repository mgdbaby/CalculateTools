...
public class DiffUtil {
    ...
    /**
     * A Listener class used by DiffUtil while calculating the diff between two lists.
     */
    ...
    public static class DiffResult {
        ...
        /**
         * Dispatches update operations to the given Listener.
         * <p>
        ...
        public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
            ...
            for (int snakeIndex = mSnakes.size() - 1; snakeIndex >= 0; snakeIndex--) {
                ...
                if (endY < posNew) {
                    dispatchAdditions(postponedUpdates, batchingCallback, endY, posNew - endY, endY);
                }
