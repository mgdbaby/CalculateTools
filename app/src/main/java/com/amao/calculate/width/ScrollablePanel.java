...
public class ScrollablePanel extends FrameLayout {
    ...
    private void initView() {
        ...
        headerRecyclerView = findViewById(R.id.recycle_header);
        ...
        if (panelAdapter != null) {
            ...
            setHeaderView(panelAdapter);
        }
    }

    private void setHeaderView(PanelAdapter panelAdapter) {
        RecyclerView.ViewHolder viewHolder = panelAdapter.onCreateViewHolder(layoutHeader, panelAdapter.getItemViewType(0, 0));
        panelAdapter.onBindViewHolder(viewHolder, 0, 0);
        layoutHeader.addView(viewHolder.itemView);
    }
