...
public abstract class AbsTask<ResultType> implements Callback.Cancelable {
    ...
    /* Update by damao at 18/5/9 11:23 */
    protected void onSuccess(ResultType result) {
        if (x.isDebug()) LogUtil.d("AbsTask onSuccess. ");
//        if (x.isDebug()) LogUtil.d("AbsTask onSuccess. result = " + result);
    }

    /* Update by damao at 18/5/9 11:23 */
    protected void onError(Throwable ex, boolean isCallbackError) {
        LogUtil.e("AbsTask onError. isCallbackError = " + isCallbackError, ex);
    }
